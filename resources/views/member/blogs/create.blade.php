                ...
                <div class="max-w-2xl">
                    <section>
                        ...
                        <form method="post" action="{{ route('member.blogs.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            ...
                            <div>
                                <x-textarea-trix id="x" name="content" value="{!! old('content') !!}"></x-textarea-trix>
                            </div>
                            <div>
                                <x-select name="status" id="status">
                                    <option value="draft" {{ old('draft'), 'selected' }}>Simpan Sebagai draft</option>
                                    <option value="published" {{ old('published'), 'selected' }}>Publish</option>
                                </x-select>
                            </div>
